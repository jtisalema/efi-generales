...
const Subdocumentos = ({
    ...
    function areThereErrors(newArray) {
        ...
        const obligatorios = newArray?.filter(subdocumento => subdocumento?.obligatorio) || [];
                    ...
                    <div className="modal-footer">
                        {hasError ?
                            <small className={"text-danger d-block w-100 text-right"}>
                                {` ${isSomeRequired ? "Recuerde adjuntar todos los documentos y llenar todos los campos de aquellos marcados con *"
